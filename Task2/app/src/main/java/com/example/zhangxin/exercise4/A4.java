...
public class A4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initComponent();
        initEvent();
        Log.d("测试输出","A4 onCreate");
    }

    @Override
    protected void onStart() {
        super.onStart();
        Log.d("测试输出","A4 onStart");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.d("测试输出","A4 onStop");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.d("测试输出","A4 onDestroy");
    }
}
